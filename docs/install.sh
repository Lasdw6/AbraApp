...
if [[ -z "$CLI" ]] || ! "$CLI" --help | grep -q "$REQUIRED_HELP"; then
  ARCHIVE_URL='https://github.com/Lasdw6/AbraApp/releases/download/agent-v0.2.2/abra-teleport-agent.tar.gz'
  EXPECTED='dc404f7e724d47dbfa234e6296c937ac81ec6c9c6c725dabb9879be6970a59b5'
